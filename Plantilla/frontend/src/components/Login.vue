<template>
    <div class="main" :style="mainStyle">
        ...
        <form v-on:submit.prevent="login" action="" method="post">
            ...
            <input type="submit" value="Ingresar" class="button" id="done" :style="inputStyle"/><br/><br/>
            <router-link :to="{name: '/Blackboard'}">
...
<script>
    ...
    methods: {
        login(){
            axios.post(this.postURL + '/token', this.user, this.config_request)
            .then(res => {
