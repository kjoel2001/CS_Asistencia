<template>
  <v-navigation-drawer
    ...
    <v-list>
      ...
      <v-list-tile @click="changeRoute('Schedulle', 2)">
        <v-list-tile-action>
          <v-icon>calendar_today</v-icon>
        </v-list-tile-action>
        <v-list-tile-title :class="[{'active': selectedIndex === 2}, 'item-title' ]"> {{ $t('Schedulle') }}</v-list-tile-title>
      </v-list-tile>

      <v-list-tile @click="changeRoute('Cursos', 3)">
        <v-list-tile-action>
          <v-icon>mail</v-icon>
        </v-list-tile-action>
        <v-list-tile-title :class="[{'active': selectedIndex === 3}, 'item-title' ]">{{ $t('Cursos') }}</v-list-tile-title>
      </v-list-tile>    

      <v-list-tile @click="changeRoute('Estudiantes', 4)">
        <v-list-tile-action>
          <v-icon>school</v-icon>
        </v-list-tile-action>
        <v-list-tile-title :class="[{'active': selectedIndex === 4}, 'item-title' ]">{{ $t('Estudiantes') }}</v-list-tile-title>
      </v-list-tile>    

      <v-list-tile @click="changeRoute('Profesores', 5)">
        <v-list-tile-action>
          <v-icon>supervisor_account</v-icon>
        </v-list-tile-action>
        <v-list-tile-title :class="[{'active': selectedIndex === 5}, 'item-title' ]">{{ $t('Profesores') }}</v-list-tile-title>
      </v-list-tile> 

      <v-list-tile @click="changeRoute('Participation', 6)">
        <v-list-tile-action>
          <v-icon>supervisor_account</v-icon>
        </v-list-tile-action>
        <v-list-tile-title :class="[{'active': selectedIndex === 6}, 'item-title' ]">{{ $t('Participation') }}</v-list-tile-title>
      </v-list-tile>    
